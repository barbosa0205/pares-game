    ...
    return (
        <>
            ...
            <div className={styles.messageGoogle}>
                <p>
                    <span>ADVERTENCIA:</span> Puede que el acceso desde google
                    falle en telefonos moviles, se recomienda crear la cuenta
                    con correo y contraseña, esta se enlaza con google si el
                    correo es Gmail
                </p>
            </div>
        </>
